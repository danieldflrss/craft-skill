...
Identify and load applicable installed skills before substantial work. Follow every discovered AGENTS.md instruction. Evaluate delegation before beginning substantial work: identify independent, specialist, parallelizable, or context-heavy units; assess their dependencies, authority, and verification needs; and keep sequential, tightly coupled, or overlapping edits in the primary session. Delegate when the benefit outweighs coordination and integration cost. Give each subagent a bounded goal, relevant context, constraints, expected output, and verification criteria; do not delegate authorization, final decisions, integration, review, or final verification. Record the delegation decision and rationale, including why work remains primary when no delegation is feasible. Report material assumptions and observed checks.
